...
def run():
    ...
    resultFile.write(' or %d out of 25' % todayNum)
    if largestFlag == True:
        resultFile.write(". Thats a new high!")
    if smallestFlag == True:
        resultFile.write(". That's a new low!")
    resultFile.write('\nSince this experiment started %f percent of articles on the frontpage of r/politics have been based on Trump, or %f per 25\n' % (avgP*100, avg))
